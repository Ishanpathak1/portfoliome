...
export function TechInnovatorTemplate({ portfolio }: TechInnovatorTemplateProps) {
  ...
  const renderHeader = () => (
    <header className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-20 flex items-center justify-center min-h-screen px-4 md:px-8">
        <div className="text-center max-w-6xl mx-auto">
          {/* Holographic avatar */}
          <div className="relative mb-8 md:mb-12">
            <div className="inline-block relative">
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-gradient-to-br from-gray-900 to-black border-4 flex items-center justify-center relative overflow-hidden"
                ...
                <span className="text-3xl md:text-5xl font-black text-white relative z-10">
              ...
              <div className="absolute -top-4 -right-4 md:-top-6 md:-right-6 w-12 h-12 md:w-16 md:h-16 animate-spin" style={{ animationDuration: '10s' }}>
                <Atom className="w-full h-full" style={{ color: colors.quantum }} />
              </div>
              <div className="absolute -bottom-4 -left-4 md:-bottom-6 md:-left-6 w-8 h-8 md:w-12 md:h-12 animate-bounce">
                <CircuitBoard className="w-full h-full" style={{ color: colors.neural }} />
              </div>
              <div className="absolute -top-2 -left-6 md:-top-4 md:-left-8 w-8 h-8 md:w-10 md:h-10 animate-pulse">
          ...
          <div className="mb-8 md:mb-12 relative">
            <div className="bg-black/90 backdrop-blur-xl border-2 rounded-2xl p-4 md:p-8 max-w-4xl mx-auto" style={{ borderColor: colors.primary }}>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
                <div className="text-center">
                  <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 rounded-full bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.primary }}>
                    <Brain className="w-6 h-6 md:w-8 md:h-8 text-white" />
                  </div>
                  <div className="text-lg md:text-2xl font-bold text-white">AI</div>
                  <div className="text-xs md:text-sm text-gray-400">Artificial Intelligence</div>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 rounded-full bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.quantum }}>
                    <Atom className="w-6 h-6 md:w-8 md:h-8 text-white" />
                  </div>
                  <div className="text-lg md:text-2xl font-bold text-white">Quantum</div>
                  <div className="text-xs md:text-sm text-gray-400">Computing</div>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 rounded-full bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.neural }}>
                    <Network className="w-6 h-6 md:w-8 md:h-8 text-white" />
                  </div>
                  <div className="text-lg md:text-2xl font-bold text-white">Neural</div>
                  <div className="text-xs md:text-sm text-gray-400">Networks</div>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 rounded-full bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.accent }}>
                    <Rocket className="w-6 h-6 md:w-8 md:h-8 text-white" />
                  </div>
                  <div className="text-lg md:text-2xl font-bold text-white">Innovation</div>
                  <div className="text-xs md:text-sm text-gray-400">Future Tech</div>
                </div>
              </div>
              
              {resumeData.summary && (
                <div className="mt-6 md:mt-8 p-4 md:p-6 bg-gradient-to-r from-transparent via-current to-transparent rounded-xl" style={{ color: colors.hologram + '10' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 mb-8 md:mb-12">
            {resumeData.contact?.email && (
              <div
                className="group relative bg-black/90 backdrop-blur-xl border-2 rounded-2xl p-4 md:p-8 hover:border-current transition-all duration-300 cursor-pointer"
                style={{ borderColor: colors.primary }}
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-sm md:text-lg font-bold text-white mb-2">Neural Link</div>
                  <a
            ...
            {resumeData.contact?.phone && (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 rounded-full bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.secondary }}>
                    <Phone className="w-6 h-6 md:w-8 md:h-8 text-white" />
                  </div>
                  <div className="text-sm md:text-lg font-bold text-white mb-2">Quantum Call</div>
                  <a
            ...
            {resumeData.contact?.location && (
              <div
                className="group relative bg-black/90 backdrop-blur-xl border-2 rounded-2xl p-4 md:p-8 hover:border-current transition-all duration-300"
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 rounded-full bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.accent }}>
                    <Satellite className="w-6 h-6 md:w-8 md:h-8 text-white" />
                  </div>
                  <div className="text-sm md:text-lg font-bold text-white mb-2">Geo Location</div>
          ...
          <div className="flex justify-center gap-4 md:gap-8">
            {resumeData.contact?.github && (
              <a
                ...
                className="group relative w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-current to-transparent flex items-center justify-center hover:scale-110 transition-transform duration-300"
                style={{ color: colors.primary }}
              >
                <div className="absolute inset-0 rounded-full border-2 animate-ping" style={{ borderColor: colors.primary }} />
                <Github className="w-8 h-8 md:w-10 md:h-10 text-white relative z-10" />
              </a>
            )}
      ...
      <section className="py-12 md:py-20 px-4 md:px-8 relative bg-black overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-20">
            ...
            <div className="w-48 md:w-64 h-2 bg-gradient-to-r from-transparent via-current to-transparent mx-auto rounded-full" style={{ color: colors.primary }} />
          </div>

          <div className="space-y-8 md:space-y-12">
            {resumeData.experience.map((exp, index) => (
              <div key={index} className="group relative">
                <div className="bg-black/90 backdrop-blur-xl border-2 rounded-3xl p-4 md:p-8 relative overflow-hidden hover:border-current transition-all duration-500" style={{ borderColor: colors.primary }}>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6 md:mb-8">
                      <div className="flex-1">
                        <div className="flex items-center gap-4 md:gap-6 mb-6">
                          <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.primary }}>
                            <Briefcase className="w-8 h-8 md:w-10 md:h-10 text-white" />
                          </div>
                          <div>
                            <h3 className="text-2xl md:text-4xl font-black text-white mb-2">{exp.position}</h3>
                            <div className="flex items-center gap-3 mb-2">
                              <div className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: colors.neon }} />
                              <span className="text-lg md:text-2xl font-bold" style={{ color: colors.secondary }}>
                                {exp.company}
                              </span>
                            </div>
                            {exp.location && (
                  ...
                  <div className="absolute top-4 right-4 w-6 h-6 md:w-8 md:h-8 border-t-2 border-r-2 rounded-tr-lg opacity-50" style={{ borderColor: colors.accent }} />
                  <div className="absolute bottom-4 left-4 w-6 h-6 md:w-8 md:h-8 border-b-2 border-l-2 rounded-bl-lg opacity-50" style={{ borderColor: colors.accent }} />
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-12 md:py-20 px-4 md:px-8 relative bg-black overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-20">
            ...
            <div className="w-48 md:w-64 h-2 bg-gradient-to-r from-transparent via-current to-transparent mx-auto rounded-full" style={{ color: colors.neural }} />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {resumeData.skills.map((skillCategory, index) => (
              <div key={index} className="group relative">
                <div className="bg-black/90 backdrop-blur-xl border-2 rounded-3xl p-4 md:p-8 relative overflow-hidden hover:border-current transition-all duration-500 h-full" style={{ borderColor: colors.neural }}>
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 md:gap-4 mb-6 md:mb-8">
                      <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.neural }}>
                        <Brain className="w-6 h-6 md:w-8 md:h-8 text-white" />
                      </div>
                      ...
                      {skillCategory.items.map((item, i) => (
                        <div key={i} className="relative">
                          <div className="flex items-center justify-between mb-3">
                            <span className="text-gray-300 font-bold text-sm md:text-lg">{item}</span>
                            <div className="flex gap-1 md:gap-2">
                              {[...Array(5)].map((_, j) => (
                                <div
                                  key={j}
                                  className={`w-2 h-2 md:w-3 md:h-3 rounded-full ${j < 4 ? 'bg-current animate-pulse' : 'bg-gray-700'}`}
                  ...
                  {/* Holographic corner elements */}
                  <div className="absolute top-4 right-4 w-6 h-6 md:w-8 md:h-8 border-t-2 border-r-2 rounded-tr-lg opacity-50" style={{ borderColor: colors.neural }} />
                  <div className="absolute bottom-4 left-4 w-6 h-6 md:w-8 md:h-8 border-b-2 border-l-2 rounded-bl-lg opacity-50" style={{ borderColor: colors.neural }} />
                </div>
              </div>
            ))}
          </div>
                  ...
                  <div className="relative z-10 p-4 md:p-8">
                    <div className="flex flex-col md:flex-row items-start justify-between mb-6 gap-4">
                      <div className="flex items-center gap-3 md:gap-4">
                        <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.accent }}>
                          <Rocket className="w-6 h-6 md:w-8 md:h-8 text-white" />
                        </div>
                        <h3 className="text-xl md:text-3xl font-black text-white">{project.name}</h3>
                      </div>
                      <div className="flex gap-3 self-start">
                        {project.github && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-current to-transparent flex items-center justify-center hover:scale-110 transition-transform duration-300"
                            style={{ color: colors.primary }}
                          >
                    ...
                    {project.technologies && (
                      <div className="flex flex-wrap gap-2 md:gap-3 mb-6 md:mb-8">
                        {project.technologies.map((tech, i) => (
                          <span
                            key={i}
                            className="px-2 py-1 md:px-4 md:py-2 rounded-full text-xs md:text-sm font-bold border-2 bg-gradient-to-r from-current to-transparent"
                            style={{ 
            ...
            {resumeData.education.map((edu, index) => (
              <div key={index} className="group relative">
                <div className="bg-black/90 backdrop-blur-xl border-2 rounded-3xl p-4 md:p-8 relative overflow-hidden hover:border-current transition-all duration-500" style={{ borderColor: colors.primary }}>
                  ...
                  <div className="relative z-10">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                      <div className="flex items-center gap-4 md:gap-6 mb-6 lg:mb-0">
                        <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.primary }}>
                          <GraduationCap className="w-6 h-6 md:w-8 md:h-8 text-white" />
                        </div>
                        <div>
                          <h3 className="text-xl md:text-3xl font-black text-white mb-2">{edu.degree}</h3>
                          <div className="flex items-center gap-3 mb-2">
                            <div className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: colors.neon }} />
                            <span className="text-lg md:text-xl font-bold" style={{ color: colors.secondary }}>
                              {edu.institution}
                            </span>
                          </div>
                          {edu.location && (
                  ...
                  {/* Holographic corner elements */}
                  <div className="absolute top-4 right-4 w-6 h-6 md:w-8 md:h-8 border-t-2 border-r-2 rounded-tr-lg opacity-50" style={{ borderColor: colors.primary }} />
                  <div className="absolute bottom-4 left-4 w-6 h-6 md:w-8 md:h-8 border-b-2 border-l-2 rounded-bl-lg opacity-50" style={{ borderColor: colors.primary }} />
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-12 md:py-20 px-4 md:px-8 relative bg-black overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="text-center mb-12 md:mb-20">
            ...
            <div className="w-48 md:w-64 h-2 bg-gradient-to-r from-transparent via-current to-transparent mx-auto rounded-full" style={{ color: colors.secondary }} />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {resumeData.certifications.map((cert, index) => (
              <div key={index} className="group relative">
                <div className="bg-black/90 backdrop-blur-xl border-2 rounded-3xl p-4 md:p-8 relative overflow-hidden hover:border-current transition-all duration-500" style={{ borderColor: colors.secondary }}>
                  ...
                  <div className="relative z-10 flex items-center gap-4 md:gap-6">
                    <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.secondary }}>
                      <Award className="w-6 h-6 md:w-8 md:h-8 text-white" />
                    </div>
                    <div>
                      <h3 className="text-lg md:text-2xl font-black text-white">{cert}</h3>
                      <div className="flex items-center gap-2 mt-2">
                        <div className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: colors.neon }} />
                        <span className="text-gray-400 text-sm md:text-base">Verified Credential</span>
                      </div>
                    </div>
                  </div>
                  
                  {/* Holographic corner elements */}
                  <div className="absolute top-4 right-4 w-6 h-6 md:w-8 md:h-8 border-t-2 border-r-2 rounded-tr-lg opacity-50" style={{ borderColor: colors.secondary }} />
                  <div className="absolute bottom-4 left-4 w-6 h-6 md:w-8 md:h-8 border-b-2 border-l-2 rounded-bl-lg opacity-50" style={{ borderColor: colors.secondary }} />
                </div>
              </div>
            ))}
          </div>
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      {/* Holographic Footer */}
      <footer className="py-12 md:py-20 px-4 md:px-8 relative bg-black overflow-hidden">
        <QuantumGrid />
        <NeuralNetwork />
        
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <div className="bg-black/90 backdrop-blur-xl border-2 rounded-3xl p-6 md:p-12 relative overflow-hidden" style={{ borderColor: colors.primary }}>
            ...
            <div className="relative z-10">
              <div className="flex justify-center mb-6 md:mb-8">
                <div className="w-16 h-16 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.primary }}>
                  <Rocket className="w-8 h-8 md:w-12 md:h-12 text-white animate-pulse" />
                </div>
              </div>
              ...
              <div className="flex justify-center gap-4 md:gap-8">
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.primary }}>
                  <Brain className="w-6 h-6 md:w-8 md:h-8 text-white animate-pulse" />
                </div>
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.quantum }}>
                  <Atom className="w-6 h-6 md:w-8 md:h-8 text-white animate-pulse" />
                </div>
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.neural }}>
                  <Network className="w-6 h-6 md:w-8 md:h-8 text-white animate-pulse" />
                </div>
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-current to-transparent flex items-center justify-center" style={{ color: colors.accent }}>
